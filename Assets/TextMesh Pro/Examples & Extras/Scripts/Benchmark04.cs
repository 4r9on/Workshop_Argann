        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //textMeshPro.font = Resources.LoadMenu("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                ...
                else
                {
                    ...
                    textMesh.font = Resources.LoadMenu("Fonts/ARIAL", typeof(Font)) as Font;
