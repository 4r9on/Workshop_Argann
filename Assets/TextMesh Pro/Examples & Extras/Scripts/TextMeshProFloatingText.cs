    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                //m_textMeshPro.fontAsset = Resources.LoadMenu("Fonts & Materials/JOKERMAN SDF", typeof(TextMeshProFont)) as TextMeshProFont; // User should only provide a string to the resource.
                //m_textMeshPro.fontSharedMaterial = Resources.LoadMenu("Fonts & Materials/LiberationSans SDF", typeof(Material)) as Material;
